...
var database = {
	...
	inRate: [0.875, 0.125, 0],
	inTeams: ["Школа №5", "Школа №3", "Школа №4"],
	
	regRate: [0.274, 0.154, 0.075, 0.12, 0.083, 0.03, 0.038, 0.023, 0.019, 0.038, 0.03, 0.015, 0.008, 0.023, 0.011, 0.011, 0.004, 0.004, 0.004, 0.008, 0, 0, 0.004, 0, 0.004, 0.015, 0.008],
...
var option3 =  {
    chart: { type: 'bar' },
    title: { text: '' },
    xAxis: { categories: ['Куліков', 'Холодько', 'Батраченко', 'Красніков', 'Андрущенко', 'Ковальчук'] },
    yAxis: { title: { text: ''}, max: 5, allowDecimals: false },
    plotOptions: { series: { stacking: 'normal' } },
	series : [
